        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <p>
                    ...
                    <a href={{route('buscar.entrada')}} class="btn btn-success">Buscar</a>
                </p>
                ...
                <table class="table">
                    ...
                    <tbody>
                            <tr>
                                ...
                                <td>9999</td>
                                <td>
                                    <a href={{route('ver.entrada')}} class="btn btn-info">Ver</a>
                                </td>
                                <td>
                                    <a href={{route('eliminar.entrada')}} class="btn btn-danger">Eliminar</a>
                                </td>
                            </tr>
                    </tbody>
